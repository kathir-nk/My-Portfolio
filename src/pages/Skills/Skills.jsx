  ...
  const skillCategories = [
  ...
  
    {
      ...
      skills: [
        ...
        {
          name: "UI Design",
          icon: <Paintbrush className="w-4 h-4 text-[#A855F7]" />,
        },
        {
          name: "Wireframing",
  ...
  
    {
      ...
      skills: [
        ...
        },
        {
          ...
          icon: <BsGrid1X2 className="w-4 h-4 text-[#3B82F6]" />,
        },
        {
  ...
  
    {
      ...
      skills: [
        {
          name: "Modern UI",
          icon: <Paintbrush className="w-4 h-4 text-[#FACC15]" />,
        },
        {
          name: "Motion Effects",
        ...
        },
        {
          ...
          icon: <Layout className="w-4 h-4 text-[#00C853]" />,
        },
        {
